...
public class Mouse extends Robot
{
	...
	public void mouseTo(int x, int y)
	{
		...
		else
		{
			...
			//delay(5);
			///getting error with y movement
			//but if i put the y if statements first i get an error on x and not y
			//what the flying fuck, literally JUST the order that affects which works and which doesn't, why?
